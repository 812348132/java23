            ...
            <div class="box">
                <div class="box-header with-border">
                    ...
                    <div class="box-tools pull-right">
                        <a href="/customer/public/new" class="btn btn-success btn-sm"><i class="fa fa-plus"></i> 新增公海客户</a>
                        <a href="/customer/public/export" class="btn btn-primary btn-sm"><i class="fa fa-file-excel-o"></i> 导出Excel</a>
                    </div>
                </div>
...
<script>
    ...
    $(".editCustomer").click(function(){
        ...
        window.location.href = "/customer/info/public/"+id;
    });
</script>
